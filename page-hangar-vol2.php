		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<img class="thumbnail" src="<?php echo esc_html( get_stylesheet_directory_uri() ); ?>/img/1-Learning-How-To-Fly-210x140.jpg" alt="" />
					<div style="height:10px;"></div>
					<img class="thumbnail" src="<?php echo esc_html( get_stylesheet_directory_uri() ); ?>/img/2-lucasonset-210x140.jpg" alt="" />
					<div style="height:10px;"></div>
					<div class="thumbnail">
						<img src="<?php echo esc_html( get_stylesheet_directory_uri() ); ?>/img/3-tricopter-210x140.jpg" alt="" />
				...
				<div class="span9">
					...
					<img src="<?php echo esc_html( get_stylesheet_directory_uri() ); ?>/img/Maker-Hangar-Main-700x400.jpg" alt="Hangar" />
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<img src="<?php echo esc_html( get_stylesheet_directory_uri() ); ?>/img/lukas.jpg" alt="Lucas Weakley" />
					<div style="height:20px;"></div>
