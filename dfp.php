    ...
    if(!empty($post_adslot_targeting_name)) {
		...
		$parent = (!empty($_REQUEST['parent']) ? $_REQUEST['parent'] : null);
			if (isset($parent)) { ?>
				...
				var slot6= googletag.defineSlot('/11548178/Makezine/Blog/<?php echo esc_js( $parent ); ?>', [[247,96]],'div-gpt-ad-664089004995786621-6').addService(googletag.pubads()).setTargeting('pos', 'atf');
		...
		<?php } elseif(is_page(array('craftzine', 235220 ))) { ?>
			...
			var slot6= googletag.defineSlot('/11548178/Makezine/Craft/Homepage', [[940,39]],'div-gpt-ad-664089004995786621-6').addService(googletag.pubads()).setTargeting('pos', 'atf');
		...
		<?php } elseif ( is_home() || is_archive() ) { ?>
			...
			var slot6= googletag.defineSlot('/11548178/Makezine/Blog<?php echo esc_js( make_get_category_name_strip_slash() ); ?>', [[940,39]],'div-gpt-ad-664089004995786621-5').addService(googletag.pubads()).setTargeting('pos', 'atf');
		...
		<?php }	elseif ( is_page(array('craftzine', 'craft-home') ) ) { ?>
			...
			var slot6= googletag.defineSlot('/11548178/Makezine/Craft/Homepage<?php echo esc_js( make_get_category_name_strip_slash() ); ?>', [[940,39]],'div-gpt-ad-664089004995786621-6').addService(googletag.pubads()).setTargeting('pos', 'atf');
